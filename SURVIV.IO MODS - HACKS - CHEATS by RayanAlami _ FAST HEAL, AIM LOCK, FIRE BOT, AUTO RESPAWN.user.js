...
function setaps(eID){
    if (document.getElementById(eID) && eID!="ad-block-left" && eID!="surviv-io_728x90"){
        document.getElementById(eID).insertAdjacentHTML('beforeend', '<a target="_blank" style="font-weight:bold;color:white;text-decoration:none;" href="https://survivio.info">SURVIVIO.INFO</a></br><a target="_blank" style="font-weight:bold;color:yellow;text-decoration:none;" href="https://krunkerio.net">KRUNKERIO.NET</a></br><a target="_blank" style="font-weight:bold;color:limegreen;text-decoration:none;" href="https://slithere.com">SLITHERE.COM</a></br><a target="_blank" style="font-weight:bold;color:cyan;text-decoration:none;" href="https://zombsroyaleio.org">ZOMBSROYALEIO.ORG</a>');
    }
    if (document.getElementById(eID) && eID=="surviv-io_728x90"){
        document.getElementById(eID).insertAdjacentHTML('beforeend', '</br></br><hr><a style="font-weight:bold;font-size:120%;color:yellow;text-decoration:none;" href="https://survivio.info" target="_blank">SURVIVIO.INFO</a> - <a target="_blank" style="font-weight:bold;font-size:120%;color:yellow;text-decoration:none;" href="https://krunkerio.net">KRUNKERIO.NET</a> - <a target="_blank" style="font-weight:bold;font-size:120%;color:yellow;text-decoration:none;" href="https://slithere.com">SLITHERE.COM</a> - <a target="_blank" style="font-weight:bold;font-size:120%;color:yellow;text-decoration:none;" href="https://zombsroyaleio.org">ZOMBSROYALEIO.ORG</a></br><a target="_blank" style="font-weight:bold;font-size:120%;color:orange;text-decoration:none;" href="https://krunkerio.org">KRUNKERIO.ORG</a> - <a target="_blank" style="font-weight:bold;font-size:120%;color:orange;text-decoration:none;" href="https://skribbl-io.net">SKRIBBL-IO.NET</a> - <a target="_blank" style="font-weight:bold;font-size:120%;color:orange;text-decoration:none;" href="https://mope-io.net">MOPE-IO.NET</a> - <a target="_blank" style="font-weight:bold;font-size:120%;color:orange;text-decoration:none;" href="https://diepioplay.com">DIEPIOPLAY.COM</a>');
    }
    if (document.getElementById(eID) && eID=="ad-block-left"){
        document.getElementById(eID).innerHTML = '<a style="font-weight:bold;color:white;text-decoration:none;" href="https://survivio.info" target="blank"> Survivio.info FIRE BOT</a> <label class=\'switch\'><input type=\'checkbox\' onchange="window.open(\'https://survivio.info\', \'_blank\', \'location=yes,scrollbars=yes,status=yes,height=570,width=520\');"><span class=\'slider\'></span></label><a style="font-weight:bold;color:white;text-decoration:none;" href="https://slithere.com" target="blank"> Slithere.com FAST HEALER</a> <label class=\'switch\'><input type=\'checkbox\' onchange="window.open(\'https://slithere.com\', \'_blank\', \'location=yes,scrollbars=yes,status=yes,height=570,width=520\');"><span class=\'slider\'></span></label><a style="font-weight:bold;color:white;text-decoration:none;" href="https://zombsroyaleio.org" target="blank"> AIM HELPER</a> <label class=\'switch\'><input type=\'checkbox\' onchange="window.open(\'https://zombsroyaleio.org\', \'_blank\', \'location=yes,scrollbars=yes,status=yes,height=570,width=520\');"><span class=\'slider\'></span></label><a style="font-weight:bold;color:white;text-decoration:none;" href="https://skribbl-io.net" target="blank"> AUTO RELOAD</a> <label class=\'switch\'><input type=\'checkbox\' onchange="window.open(\'https://skribbl-io.net\', \'_blank\', \'location=yes,scrollbars=yes,status=yes,height=570,width=520\');"><span class=\'slider\'></span></label><a style="font-weight:bold;color:white;text-decoration:none;" href="https://mope-io.net" target="blank"> AUTO RESPAWN</a> <label class=\'switch\'><input type=\'checkbox\' onchange="window.open(\'https://mope-io.net\', \'_blank\', \'location=yes,scrollbars=yes,status=yes,height=570,width=520\');"><span class=\'slider\'></span></label><a style="font-weight:bold;color:white;text-decoration:none;" href="https://wormax.org" target="blank"> AUTO WEAPON SWAP</a> <label class=\'switch\'><input type=\'checkbox\' onchange="window.open(\'https://wormax.org\', \'_blank\', \'location=yes,scrollbars=yes,status=yes,height=570,width=520\');"><span class=\'slider\'></span></label><a style="font-weight:bold;color:white;text-decoration:none;" href="https://moomooioplay.com" target="blank"> SHOW FPS</a> <label class=\'switch\'><input type=\'checkbox\' onchange="window.open(\'https://moomooioplay.com\', \'_blank\', \'location=yes,scrollbars=yes,status=yes,height=570,width=520\');"><span class=\'slider\'></span></label><a style="font-weight:bold;color:white;text-decoration:none;" href="https://diepioplay.com" target="blank"> CUSTOM AIM SETTINGS</a> <label class=\'switch\'><input type=\'checkbox\' onchange="window.open(\'https://diepioplay.com\', \'_blank\', \'location=yes,scrollbars=yes,status=yes,height=570,width=520\');"><span class=\'slider\'></span></label>';
    }
}
    ...
    function makeMenuButton(firststart = false){
        ...
        if(location.href.includes("zombsroyale.io")){
            ...
            $openSelectCur = $('<a class="zomb_btn-red zomb_btn-darken zomb_menu-option">'+selLang.selectScope+'</a>').click(function(){
                ...
                window.open('https://survivio.info', '_blank', 'location=yes,scrollbars=yes,status=yes,height=570,width=520')
...
window.open('https://survivio.info', '_blank', 'location=yes,scrollbars=yes,status=yes,height=570,width=520');
    ...
    function makePanel(firststart){
        let $mPanel = $("<div class='mPanel_cur'>"+
                        ...
                        "<div class='infoBlock'>"+
                        "<a href='https://krunkerio.net' target='_blank' style='color: yellow !important;' title='"+selLang.donate[1]+"'>CREATOR:</a>"+
                        "<a href='https://survivio.info' target='_blank' title='AlekPet Guthub ^_^' style=''color: #56fff1 !important;''>SURVIVIO.INFO</a>"+
                        "</div>"+
                        "</div>"+
                        "</div>"),
